    ...
    return (
        <Layout>
            <section className="h-full gradient-form bg-gray-200">
                <div className="h-32 bg-about-banner bg-auto md:bg-contain bg-no-repeat bg-center">
                    <div className="container mx-auto px-6">
                        <div className="sm:flex">
                            <div className="sm:w-full sm:px-8 flex flex-col md:flex-row justify-center">
                                <h3 className="py-4 text-center text-black font-sans font-semibold">
                                    FAQ
    		               		</h3>
                            </div>
                        </div>
